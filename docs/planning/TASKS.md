...
### T-030 Добавить модель и API `BookingRequest`
- Priority: P0
- Status: todo
- DoD:
...
### T-051 Telegram-адаптер (MVP)
- Priority: P1
- Status: todo
- DoD:
  - Участник: просмотр, поиск, создание заявки, получение статусов.
  - Завснар: оповещения о новых заявках и просрочках.
