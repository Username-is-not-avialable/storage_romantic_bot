...
- Примечание: request-id в логах реализован (см. [LOGGING.md](../tech/LOGGING.md)); остаётся единый обработчик ошибок.
...
- Примечание: маскирование PII в логах внедрено (см. [LOGGING.md](../tech/LOGGING.md)); пункт о traceback в ответах API остаётся актуальным.
